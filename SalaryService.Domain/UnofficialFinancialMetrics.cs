...
{
    public UnofficialFinancialMetrics(FinancesForPayroll financesForPayroll, CoefficientOptions coefficients, WorkingPlan workingPlan, Instant createdAtUtc) 
        : base(financesForPayroll, coefficients, workingPlan, createdAtUtc)
    {
    }
