...
{
    public abstract class FinancialMetrics
    {
        ...
        public FinancialMetrics(FinancesForPayroll financesForPayroll, CoefficientOptions coefficients, WorkingPlan workingPlan)
        {
            // probably it's better to use validation in setters
