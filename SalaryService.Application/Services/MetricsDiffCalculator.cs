...
namespace SalaryService.Application.Services
{
    public static class MetricsDiffCalculator
    {
        ...
        {
            if (sourceMetrics.EmployeeId != newMetrics.EmployeeId)
            {
            ...
            {
                EmployeeId = sourceMetrics.EmployeeId,
        ...
        public static TotalEmployeeFinancialMetrics CalculateTotalEmployeeFinancialMetrics(
            List<EmployeeFinancialMetrics> metrics)
        {
            return new TotalEmployeeFinancialMetrics
            {
        ...
        public static EmployeeFinancialTotalMetricsDiff CalculateDiffBetweenTotalEmployeeFinancialMetrics(
            TotalEmployeeFinancialMetrics sourceTotalMetrics, TotalEmployeeFinancialMetrics newTotalMetrics)
        {
