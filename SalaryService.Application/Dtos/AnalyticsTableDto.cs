...
namespace SalaryService.Application.Dtos
{
    public class AnalyticsTableDto
    {
        ...
        public AnalyticsTableDto(IEnumerable<Employee> employees, TotalEmployeeFinancialMetricsEntry employeesTotalFinancialMetrics)
        {
            Rows = employees.Select(x => new RowDto
            {
                ...
                IsCopy = false,
                Metrics = new EmployeeMetricsRowDto(x.EmployeeFinancialMetrics),
                MetricsDiff = null
            });
        ...
        public AnalyticsTableDto(AnalyticsMetricChanges metricsChanges)
        {
    ...
    public class EmployeeMetricsRowDto
    {
        ...
        public EmployeeMetricsRowDto(EmployeeFinancialMetrics? employeeFinancialMetrics)
        {
